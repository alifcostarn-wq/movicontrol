...
const MIDIA_LADO_MAX  = Number(process.env.ATEND_MIDIA_LADO || 1600);
const MIDIA_QUALIDADE = Number(process.env.ATEND_MIDIA_QUALIDADE || 72);
...
async function otimizarMidia(bytes, mimetype) {
...
const emKB = n => Math.round(n / 1024) + ' KB';
